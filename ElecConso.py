...
def read_SMA(counter):
    try:
        ...
        print ("SMA Sunnyboy not reachable please take action")
        send_mail('rpi@one2care.be', 'bruno.faucon@one2care.be', 'Alerte Raspberry', 'SMA Sunnyboy not reachable please take action')
        pow_current = '0'
        power_total = '0'
    finally:
...
def read_homewizard_P1(counter):
    try:
        ...
        print ("Homewizard not reachable please take action")
        send_mail('rpi@one2care.be', 'bruno.faucon@one2care.be', 'subject', 'Homewizard P1 not reachable please take action')
        power_totalG = '0'
    finally:
...
def read_homewizard_SDM230(counter):
    try:
        ...
        print ("Homewizard not reachable please take action")
        send_mail('rpi@one2care.be', 'bruno.faucon@one2care.be', 'subject', 'Homewizard SDM230 not reachable please take action')
        active_power_w = 0
...
def read_homewizard_SOCKET(counter):
    try:
        ...
        print ("Homewizard SDM230 not reachable please take action")
        send_mail('rpi@one2care.be', 'bruno.faucon@one2care.be', 'subject', 'Homewizard SDM230 not reachable please take action')
        active_power_w = 0
...
def get_delta(counter,newvalue):
    try:
        ...
        send_mail('rpi@one2care.be', 'bruno.faucon@one2care.be', 'Alerte Raspberry Pi', 'issue with delta calculation')
        return '0'
    finally:
        return delta
